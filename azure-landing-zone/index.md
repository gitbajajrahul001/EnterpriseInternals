...
| Part | Topic | Focus |
|------|------|------|
| 1 | [Why Landing Zones Fail](part1-why-landing-zones-fail.md) | Real-world failures and mistakes |
| 2 | [Opinionated Target Architecture](part2-opinionated-architecture.md) | Why strong design direction is required |
| 3 | [Management Group Design](part3-management-groups.md) | Governance boundaries and hierarchy |
| 4 | [Subscription Strategy](part4-subscriptions.md) | Ownership, cost, and isolation |
| 5 | [Network Architecture](part5-network.md) | Hub-spoke, traffic flow, and control |
| 6 | [Identity & Access Design](part6-identity.md) | RBAC, PIM, Zero Trust |
| 7 | [Security & Governance](part7-governance.md) | Policy, Defender, compliance |
| 8 | [Deployment & Automation](part8-automation.md) | Terraform, CI/CD, platform engineering |
| 9 | [FinOps & Cost Strategy](part9-finops.md) | Cost control, ownership, optimization |

---

## ▶️ Start the Journey

👉 **[Begin with Part 1: Why Landing Zones Fail](part1-why-landing-zones-fail.md)**
