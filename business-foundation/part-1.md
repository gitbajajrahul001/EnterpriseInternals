...
There is no such thing as a “good decision” in isolation. 
Every decision comes at the cost of something else.
...
If your proposal does not acknowledge trade-offs, it feels incomplete.
...
You may propose the right thing. 
But if the timing is wrong, it will not move.
...
They build or lose momentum over time.
...
But you do need to think in terms of:
